	...
	<div class="container">
		...
		<div class="form-group">
			...
			<div class="d-flex">
				...
				<button class="btn btn-info" type="button" id="nameCheckBtn">중복확인</button>
			</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#nameCheckBtn").on('click', function(){
				...
				$.ajax({
					//request
					type:"GET" // 생략 가능 <- 아무타입도 명시하지 않으면 get
			...
			$("#joinBtn").on('click', function(){
				...
				console.log($('#nameStatusArea').children()); //자식이 있는지 없는지는 length로 확인
